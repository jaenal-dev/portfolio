...
const About = () => {
	return (
		<>
			...
			>
				I have an interest in programming, one of my favorite languages,
				namely PHP and Javascript. I am a fast learner and collaborate
				closely with teams to create efficient, scalable and
